  ...
  return (
    <div className="w-full">
      ...
      <section className="relative h-screen flex items-center">
        ...
        {/* Background Image */}
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=1800')] bg-cover bg-center"></div>
