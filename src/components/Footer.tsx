        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-gray-300">
              A modern institution dedicated to excellence in education and research, preparing students for the challenges of tomorrow.
            </p>
            <div className="mt-4 flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-blue-accent">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-blue-accent transition-colors">Student Portal</a></li>
              <li><a href="#" className="text-gray-300 hover:text-blue-accent transition-colors">Faculty Portal</a></li>
              <li><a href="#" className="text-gray-300 hover:text-blue-accent transition-colors">Campus Map</a></li>
              <li><a href="#" className="text-gray-300 hover:text-blue-accent transition-colors">Library</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <ul className="flex space-x-6 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-blue-accent transition-colors">Terms of Service</a></li>
              <li><a href="#" className="hover:text-blue-accent transition-colors">Cookie Policy</a></li>
            </ul>
          </div>
        </div>
      </div>
